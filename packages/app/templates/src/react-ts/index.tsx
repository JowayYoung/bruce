...
function App(): JSX.Element {
	return (
		<div className="main-page pr">
			...
			<BrowserRouter>
				<nav className="nav">
					<NavLink className={({ isActive }: classObj): string => `nav-item${isActive ? " active" : ""}`} to="/">Home</NavLink>
					<NavLink className={({ isActive }: classObj): string => `nav-item${isActive ? " active" : ""}`} to="/about">About</NavLink>
				</nav>
				<Routes>
